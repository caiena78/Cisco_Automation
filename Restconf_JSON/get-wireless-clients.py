...
# python get-wireless-client.py --deviceip <ip> --username <username> --password <password> 
...
if __name__ == "__main__":
    ...
    url = f"https://{device['ip']}:{device['port']}/restconf/data/Cisco-IOS-XE-wireless-client-oper:client-oper-data"
